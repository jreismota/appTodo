 ...
 */
package br.edu.unipam.apptodo.report;
 ...
 *
 * @author josereis
 * baseado no exemplo disponível em: https://www.vogella.com/tutorials/JavaPDF/article.html
 */
public class TarefaReport {
    ...
    private static final Font catFont = new Font(Font.TIMES_ROMAN, 18,
            Font.BOLD);
    private static final Font redFont = new Font(Font.TIMES_ROMAN, 12,
            Font.NORMAL, Color.RED);
    private static final Font subFont = new Font(Font.TIMES_ROMAN, 16,
            Font.BOLD);
    private static final Font smallBold = new Font(Font.TIMES_ROMAN, 12,
            Font.BOLD);
